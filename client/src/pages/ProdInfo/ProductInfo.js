                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <div className="grid grid-cols-2 gap-2">
                        <div className={"badge " + (product.deliveryAvailable ? "badge-success" : "badge-error")}>{t('Delivery')} {product.deliveryAvailable ? t("Available") : t("Not Available")}</div>
                        <div className={"badge " + (product.boxAvailable ? "badge-success" : "badge-error")}>{t('Box')} {product.boxAvailable ? t("Available") : t("Not Available")}</div>
                        <div className={"badge " + (product.warrantyAvailable ? "badge-success" : "badge-error")}>{t('Warranty')} {product.warrantyAvailable ? t("Available") : t("Not Available")}</div>
                        <div className={"badge " + (product.accessoryAvailable ? "badge-success" : "badge-error")}>{t('Accessories')} {product.accessoryAvailable ? t("Available") : t("Not Available")}</div>
                      </div>
                    </div>
                  </div>
                  <Button className='focus:outline-none mt-2' onClick={() => setShowbid(!showbid)} disabled={user._id === product.seller._id}>{t('New Bid')}</Button>
                </div>
              </div>
            </div>
            <div className="w-full md:w-1/2">
              <h3 className="text-lg font-bold">{t('Bids')}</h3>
              <Divider />
